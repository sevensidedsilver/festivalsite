...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SingleValueStream</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SingleValueStream</h1>
...
<article>
    ...
    <h4 class="name" id="SingleValueStream"><span class="type-signature"></span>new SingleValueStream<span class="signature">(options)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_single-value-stream.js.html">lib/util/single-value-stream.js</a>, <a href="lib_util_single-value-stream.js.html#line14">line 14</a>
    </li></ul></dd>
